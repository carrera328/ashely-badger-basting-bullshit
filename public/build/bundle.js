...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Get me some mfing knowledge cuzzo";
    			attr_dev(input, "type", "text");
    			attr_dev(input, "data-id", "ashley-input");
    			attr_dev(input, "placeholder", "I want to learn about...");
    			attr_dev(input, "class", "svelte-1bmv2do");
    			add_location(input, file$3, 35, 4, 701);
    			attr_dev(button, "data-id", "server");
    			attr_dev(button, "class", "svelte-1bmv2do");
    			add_location(button, file$3, 36, 4, 811);
    			attr_dev(main, "class", "svelte-1bmv2do");
    			add_location(main, file$3, 34, 0, 673);
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const handleKeyUp = event => {
    		...
    		ashleyInput = event.target.value;
    	};
    	...
    	const handleClick = () => {
    		...
    		if (!ashleyInput) {
    			alert('Type in what you wanna learn about');
    			return;
    		}

    		aiPrompt = `Tell me a fun fact about ${ashleyInput}`;

    		root.dispatchEvent(new CustomEvent("quoteclick",
    		{
    				detail: aiPrompt,
    				bubbles: true,
    				composed: true
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('ashleyInput' in $$props) ashleyInput = $$props.ashleyInput;
    	};
    	...
    	return [root, handleKeyUp, handleClick, main_binding];
    }
    ...
    /* src/components/Quote.svelte generated by Svelte v3.55.1 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			t = text(/*quote*/ ctx[0]);
    			attr_dev(div, "class", "content svelte-14fpomm");
    			add_location(div, file$2, 5, 4, 53);
    			attr_dev(main, "class", "svelte-14fpomm");
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*quote*/ 1) set_data_dev(t, /*quote*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (quote === undefined && !('quote' in $$props || $$self.$$.bound[$$self.$$.props['quote']])) {
    ...
    class Quote extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { quote: 0 });
    ...
    /* node_modules/svelte-loading-spinners/DoubleBounce.svelte generated by Svelte v3.55.1 */
    const file$1 = "node_modules/svelte-loading-spinners/DoubleBounce.svelte";
    ...
    // (12:1) {#each range(2, 1) as version}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 12, 2, 441);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			mount_component(quote_1, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const quote_1_changes = {};
    			if (dirty & /*quote*/ 2) quote_1_changes.quote = /*quote*/ ctx[1];
    		...
    		d: function destroy(detaching) {
    			destroy_component(quote_1, detaching);
    		}
    	};
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Knowledge for Ashley";
    			t1 = space();
    			div0 = element("div");
    			if_block.c();
    			t2 = space();
    			...
    			attr_dev(h1, "class", "title svelte-17dkun");
    			add_location(h1, file, 40, 4, 1105);
    			attr_dev(div0, "class", "quote svelte-17dkun");
    			add_location(div0, file, 43, 4, 1156);
    			attr_dev(div1, "class", "button svelte-17dkun");
    			add_location(div1, file, 50, 4, 1352);
    			attr_dev(main, "class", "container svelte-17dkun");
    			add_location(main, file, 39, 0, 1059);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const handleQuoteClick = async event => {
    		$$invalidate(1, quote = await getAI(event.detail));
    	...
    	return [root, quote, loading, main_binding];
    }
